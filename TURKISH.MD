...
export INITIAL_STAKE=32000000000000000000  # 32 OG gwei cinsinden
...
echo $INITIAL_STAKE
# Tam olarak 32000000000000000000 olmalı (32 OG gwei cinsinden)
```
...
- ✅ **tokens()** 32000000000000000000 (32 OG) döndürür
